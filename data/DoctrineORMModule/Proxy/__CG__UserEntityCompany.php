 ...
 */
class Company extends \User\Entity\Company implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'User\\Entity\\Company' . "\0" . 'name', '' . "\0" . 'User\\Entity\\Company' . "\0" . 'displayName', '' . "\0" . 'User\\Entity\\Company' . "\0" . 'companyId', 'inputFilter');
        }
