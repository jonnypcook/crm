 ...
 */
class Brand extends \Product\Entity\Brand implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Product\\Entity\\Brand' . "\0" . 'name', '' . "\0" . 'Product\\Entity\\Brand' . "\0" . 'description', '' . "\0" . 'Product\\Entity\\Brand' . "\0" . 'prefix', '' . "\0" . 'Product\\Entity\\Brand' . "\0" . 'brandId');
        }
