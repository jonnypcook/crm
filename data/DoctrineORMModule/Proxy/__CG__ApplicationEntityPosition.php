 ...
 */
class Position extends \Application\Entity\Position implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Position' . "\0" . 'name', '' . "\0" . 'Application\\Entity\\Position' . "\0" . 'label', '' . "\0" . 'Application\\Entity\\Position' . "\0" . 'userPositionId', 'inputFilter');
        }
    ...
    public function getUserPositionId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getUserPositionId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserPositionId', array());

        return parent::getUserPositionId();
    }
    ...
    public function setUserPositionId($userPositionId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserPositionId', array($userPositionId));

        return parent::setUserPositionId($userPositionId);
    }
