 ...
 */
class DocumentExtension extends \Project\Entity\DocumentExtension implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Project\\Entity\\DocumentExtension' . "\0" . 'extension', '' . "\0" . 'Project\\Entity\\DocumentExtension' . "\0" . 'header', '' . "\0" . 'Project\\Entity\\DocumentExtension' . "\0" . 'documentExtensionId', 'inputFilter');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DocumentExtension $proxy) {
    ...
    public function getDocumentExtensionId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getDocumentExtensionId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDocumentExtensionId', array());

        return parent::getDocumentExtensionId();
    }
    ...
    public function setDocumentExtensionId($documentExtensionId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDocumentExtensionId', array($documentExtensionId));

        return parent::setDocumentExtensionId($documentExtensionId);
    }
