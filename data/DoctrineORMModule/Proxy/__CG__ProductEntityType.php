 ...
 */
class Type extends \Product\Entity\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Product\\Entity\\Type' . "\0" . 'name', '' . "\0" . 'Product\\Entity\\Type' . "\0" . 'description', '' . "\0" . 'Product\\Entity\\Type' . "\0" . 'service', '' . "\0" . 'Product\\Entity\\Type' . "\0" . 'typeId');
        }
