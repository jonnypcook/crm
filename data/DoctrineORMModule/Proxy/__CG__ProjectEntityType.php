 ...
 */
class Type extends \Project\Entity\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Project\\Entity\\Type' . "\0" . 'name', '' . "\0" . 'Project\\Entity\\Type' . "\0" . 'processor', '' . "\0" . 'Project\\Entity\\Type' . "\0" . 'typeId');
        }
